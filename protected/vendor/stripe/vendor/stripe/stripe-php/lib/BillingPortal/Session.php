 ...
 * @property null|string $locale The IETF language tag of the locale Customer Portal is displayed in. If blank or auto, the customerâs <code>preferred_locales</code> or browserâs locale is used.
