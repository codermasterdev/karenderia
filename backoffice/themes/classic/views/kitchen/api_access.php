...
<h6 class="mb-3 mt-4"><?php echo t("Mobile API URL")?></h6>    
  ...
  <div class="form-label-group mt-2">    
   <?php echo $form->textArea($model,'kitchen_jwt_token',array(
     'class'=>"form-control form-control-text",     
     'placeholder'=>t("Contact Content"),
     'disabled'=>true,     
   )); ?>      
   <?php echo $form->error($model,'kitchen_jwt_token'); ?>
...
<?php else :?>
 ...
 <div class="form-label-group">    
   <?php echo $form->hiddenField($model,'kitchen_jwt_token',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>$form->label($model,'kitchen_jwt_token'),     
   )); ?>       
   <?php echo $form->error($model,'kitchen_jwt_token'); ?>
</div>
