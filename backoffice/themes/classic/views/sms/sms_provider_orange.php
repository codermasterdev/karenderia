...
<div class="form-label-group">    
   <?php echo $form->textField($model,'key1',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>t("Authorization Basic")
   )); ?>   
   <?php    
    echo $form->labelEx($model,'key1',array(
     'label'=>t("Authorization Basic")
    )); ?>
...
<div class="form-label-group">    
   <?php echo $form->textField($model,'key2',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>t("Country sender number")
   )); ?>   
   <?php    
    echo $form->labelEx($model,'key2',array(
     'label'=>t("Country sender number")
    )); ?>
   <?php echo $form->error($model,'key2'); ?>
</div>

<div class="form-label-group">    
   <?php echo $form->textField($model,'key5',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>t("Sender name")
   )); ?>   
   <?php    
    echo $form->labelEx($model,'key5',array(
     'label'=>t("Sender name")
    )); ?>
...
<div class="form-label-group">    
   <?php echo $form->textField($model,'key4',array(
     'class'=>"form-control form-control-text",
     'placeholder'=>t("Client secret")
   )); ?>   
   <?php    
    echo $form->labelEx($model,'key4',array(
