<?php
class AR_location_time_estimate extends CActiveRecord
{	
	...
	{
		return array(
		  array('service_type,merchant_id,country_id,state_id,city_id,area_id', 
		  ...
		  array('estimated_time_min,estimated_time_max', 'numerical', 
			'integerOnly' => false, 
			'min' => 1, 
			'tooSmall' => 
			t("{attribute} minimum value is 1")
		  ),			
	...
	public function validateLocation($attribute, $params)
	{
		...
		if(AR_location_time_estimate::model()->findAll($criteria)){		
