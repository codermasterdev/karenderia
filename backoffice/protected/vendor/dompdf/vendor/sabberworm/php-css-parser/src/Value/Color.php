...
/**
 * `Color's can be input in the form #rrggbb, #rgb or schema(val1, val2, â¦) but are always stored as an array of
 * ('s' => val1, 'c' => val2, 'h' => val3, â¦) and output in the second form.
 */
