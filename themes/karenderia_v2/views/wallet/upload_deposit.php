...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row align-items-center py-2">
            <div class="col-5 col-md-4 font-weight-bold text-muted">
                <?php echo t("Payment Reference") ?>:
            </div>
        ...
        <div class="row align-items-center py-2">
            <div class="col-4 col-md-3 font-weight-bold text-muted">
                <?php echo t("Amount") ?>:
            </div>
            <div class="col text-right">
                <?php echo Price_Formatter::formatNumber($order['amount'] ?? 0) ?>
            </div>
        </div>
