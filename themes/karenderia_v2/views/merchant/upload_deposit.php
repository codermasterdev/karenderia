...
<div class="row">
    <div class="col-md-6">
        ...
        <div class="row pb-2">    
           <div class="col-3"><?php echo t("Plan")?></div>
           <div class="col">
        ...
        <div class="row pb-2">    
           <div class="col-3"><?php echo t("Plan Period")?></div>
           <div class="col">
            <?php echo t($plans->billing_cycle);?>
           </div>
        </div>    

        <div class="row pb-2">    
           <div class="col-3"><?php echo t("Amount")?></div>
           <div class="col">
            <?php echo Price_Formatter::formatNumber($plans->amount)?>
           </div>
        </div>    
