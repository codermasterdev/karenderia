    ...
    <q-layout view="lHh Lpr lff" >
      ...
      <template v-if="chatting_to">                     
        <q-toolbar style="border: 1px solid #ddd" class="radius10 q-pa-sm" >            
          ...
          <q-toolbar-title>
            <div>                
              <h6 class="q-ma-none q-pa-none line-normal">{{ chatting_to.first_name }} {{ chatting_to.last_name }} </h6>
      ...
      >
        ...
        <div class="q-pa-md">
          ...
          :label="{              
              search_chat : '<?php echo CJavaScript::quote( t("Search restaurants") )?>',               
          }"  			       
         ...
         <div class="fit">
          ...
          <!-- CHAT MESSAGES -->               
            ...
            :label="{              
                ...
                please_wait : '<?php echo CJavaScript::quote( t("Please wait...") )?>',                                  
                send : '<?php echo CJavaScript::quote( t("Send") )?>',                                  
            }"  			         
