...
return array (
  'Home' => 'Home',
  'The button type "{type}" is not supported.' => 'Il pulsante "{type}" non Ã¨ supportato.',
  ...
  'Please specify the "attributes" property.' => 'Occorre specificare la proprietÃ  "attributes".',
  'Please specify the "data" property.' => 'Occorre specificare la proprietÃ  "data".',
  'Sort by: ' => 'Ordina per:',
  'The "dataProvider" property cannot be empty.' => 'La proprietÃ  "dataProvider" non puÃ² essere vuota.',
  ...
  'The property "itemView" cannot be empty.' => 'La proprietÃ  "itemView" non puÃ² essere vuota.',
  'Total 1 result.|Total {count} results.' => 'Totale di 1 risultato.|Totale di {count} risultati.',
  'Update' => 'Aggiorna',
  'View' => 'Vedi',
  '{class} must specify "model" and "attribute" or "name" property values.' => '{class} deve specificare il/i valore/i delle proprietÃ  "model" e "attribute" o "name".',
);