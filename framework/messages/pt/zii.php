 ...
 */
return array (
  'The button type "{type}" is not supported.' => 'O boṭo do tipo "{type} ṇo ̩ suportado"',
  ...
  'Sort by: ' => 'Ordenar por: ',
  'The "dataProvider" property cannot be empty.' => 'A propriedade "dataProvider" ṇo pode estar vazia.',
  'The attribute must be specified in the format of "Name:Type:Label", where "Type" and "Label" are optional.' => 'O atributo deve ser especificado no formato "Nome:Tipo:Etiqueta", onde "Tipo" e "Etiqueta" ṣo opcionais.',
  'The column must be specified in the format of "Name:Type:Label", where "Type" and "Label" are optional.' => 'A coluna deve ser especificada no formato "Nome:Tipo:Etiqueta", onde "Tipo" e "Etiqueta" ṣo opcionais.',
  'The property "itemView" cannot be empty.' => 'A propriedade "itemView" ṇo pode estar vazia.',
