...
return array (
  'Home' => 'Home',
  'The button type "{type}" is not supported.' => 'El tipus de botÃ³ "{type}" no Ã©s suportat.',
  'The property filterSelector should be defined.' => 'La propietat filterSelector haurÃ­a d\'estar definida.',
  'The property updateSelector should be defined.' => 'La propietat updateSelector haurÃ­a d\'estar definida.',
  'Are you sure you want to delete this item?' => 'De debÃ² que vol eliminar aquest element?',
  'Delete' => 'Eliminar',
  ...
  'The attribute must be specified in the format of "Name:Type:Label", where "Type" and "Label" are optional.' => 'L\'atribut ha d\'especificar-se en el format "Nom:Tipus:Etiqueta", en quÃ¨ "Tipus" i "Etiqueta" sÃ³n opcionals.',
  'The column must be specified in the format of "Name:Type:Label", where "Type" and "Label" are optional.' => 'La columna ha d\'especificar-se en el format "Nom:Tipus:Etiqueta", en quÃ¨ "Tipus" i "Etiqueta" sÃ³n opcionals.',
